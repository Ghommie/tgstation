...
/obj/item/organ/snout/on_bodypart_insert(obj/item/bodypart/head/limb)
	. = ..()
	if(limb.skeleton_part == /obj/item/bodypart/head/skeleton) //if the skeleton part of our head is the generic skeleton head, then change it to snouted
		limb.skeleton_part = /obj/item/bodypart/head/skeleton/snouted
...
/obj/item/organ/snout/on_bodypart_remove(obj/item/bodypart/head/limb, movement_flags)
	if(worn_mask_offset)
		...
		limb.skeleton_part = initial(limb.skeleton_part)
	return ..()
