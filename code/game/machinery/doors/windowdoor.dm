...
/obj/machinery/door/window/try_to_crowbar(obj/item/crowbar, mob/user, forced = FALSE)
	if(istype(crowbar, /obj/item/crowbar/power))
		var/obj/item/crowbar/power/power_tool = crowbar
