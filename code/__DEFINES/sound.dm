...
#define SFX_JOYSTICK_SHAFT "joystick_shaft"
#define SFX_JOYSTICK_BUTTON_PRESS "joystick_button_press"
#define SFX_JOYSTICK_BUTTON_RELEASE "joystick_button_release"
